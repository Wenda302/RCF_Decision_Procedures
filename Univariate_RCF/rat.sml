...
fun exp (r, Rat (true, n, 1))  = exp_aux mult r n one
  | exp (r, Rat (false, n, 1)) = exp_aux mult (inv r) n one
  | exp (r,s) = raise Rat_Error ("Rat.exp " ^ toString r ^ " " ^ toString s);
